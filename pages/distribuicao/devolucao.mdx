...
## Troca Direta entre setores

Para empréstimos rápidos entre setores (sem passar pelo ciclo completo de esterilização), utilize o fluxo de **Troca Direta** no menu **Entrada/Saída**:

- **Nova Troca Direta:** registra o empréstimo com setor de destino e prazo de retorno
- **Baixa de Troca Direta:** encerra o empréstimo quando o material não retornará
- **Devolução de Troca Direta:** registra o retorno físico do material à CME

...
> Para materiais sujos vindos do centro cirúrgico ou outros setores, o fluxo começa pelo ciclo de lavagem no expurgo, não por esta tela.
...
- Você pode adicionar vários modelos diferentes em um mesmo lote antes de confirmar
- O botão **Limpar formulário** reinicia os campos sem apagar o que já foi adicionado ao lote
- Materiais registrados nesta tela entram no sistema com status **Limpo — Aguardando Preparo**

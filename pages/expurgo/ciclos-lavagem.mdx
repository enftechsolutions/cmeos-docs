---
title: Iniciar Ciclo de Lavagem
...
## Lavagem manual (bancada)

Para materiais que precisam de lavagem manual:

1. Selecione os materiais na fila
2. No painel **Lavagem Manual**, clique em **Iniciar Limpeza Manual**
3. O ciclo será registrado com o operador responsável e horário de início
4. Ao finalizar fisicamente a lavagem, clique em **Finalizar** para liberar os itens

---
title: Impressão da Etiqueta de Rastreabilidade
...
Se precisar reimprimir uma etiqueta de um material já preparado:

1. Acesse o módulo de **Auditoria**
2. Selecione a aba **Preparo**
...
Para configurar o modelo e tamanho de etiqueta utilizado, acesse **Configurações → Impressora** no menu lateral.

Veja o guia completo em: [Impressão de Etiquetas →](/impressao)
